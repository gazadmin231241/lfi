...
только если Codex вернул статус через тегированный блок завершения LFI. Каждый worker и
...
успешный выход только при наличии commits относительно base и чистом worktree.
Общая integration-ветка обязана пройти
