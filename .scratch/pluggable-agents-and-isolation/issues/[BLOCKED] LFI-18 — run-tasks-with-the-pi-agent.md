...
- [LFI-15 — Adopt the completion block as the result contract](<[BLOCKED] LFI-15 — adopt-the-completion-block-as-the-result-contract.md>)
...
- [LFI-17 — Pair each execution tier with an agent](<[BLOCKED] LFI-17 — pair-each-execution-tier-with-an-agent.md>)
